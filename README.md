...
```
git clone --depth=1 https://github.com/scipioartelius/nera.git <project_name>
```
...
```
mongod (Linux: sudo service mongod start))
```
...
| passport-eve                    | Sign-in with EVE Single SignOn                                        |
